...
@app.put(
    "/catalog-products",
    summary="Add products to the catalog",
    openapi_extra={
...
@app.put(
    "/products-from-table",
    summary="Add products from a table",
    openapi_extra={
...
async def products_from_table(request: Request):
    ...
    for row in table["rows"]:
        ...
        for heading, value in zip(headings, row, strict=False):
            if heading == "price":
...
@app.put(
    "/category",
    summary="Add a category with description",
    openapi_extra={
...
@app.put(
    "/broken-validation",
    summary="Endpoint that rejects input",
    openapi_extra={
...
@app.put(
    "/broken-logic-error",
    summary="Endpoint that returns a logical error",
    openapi_extra={
